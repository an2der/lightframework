...
public class ProjectUtil {
    ...
    public static String getProjectRootPath() {
        ...
        try {
            ...
            throw new LightException("Unsupported Encoding "+enc,e);
        }
    ...
    public static String getProjectVersion(Class startMainClass) {
        ...
        if(baseFile != null && baseFile.isFile()){
            ...
            try {
                ...
                throw new LightException("Read file (MANIFEST.MF) error in " + baseFile.getAbsolutePath(),e);
            }
            if(manifest != null){
                return manifest.getMainAttributes().getValue("Implementation-Version");
            }else {
                throw new LightException("Not found file (MANIFEST.MF) in " + baseFile.getAbsolutePath());
            }
        }else {
    ...
    public static Manifest getProjectManifest(Class startMainClass) {
        ...
        if(baseFile != null && baseFile.isFile()) {
            try {
                ...
                throw new LightException("Unable to read file!",e);
            }
        }
        return null;
    }
    ...
    private static File getClassBaseFile(Class clazz){
        try {
            ...
            throw new LightException("Unsupported Encoding UTF-8",e);
        }
    }
    ...
    private static Class getClazz(){
        try {
            ...
            throw new LightException("Class Not Found!",e);
        }
    }
