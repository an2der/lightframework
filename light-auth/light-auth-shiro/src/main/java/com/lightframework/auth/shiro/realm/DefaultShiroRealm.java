...
public class DefaultShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        if(userInfo != null){
            return new SimpleAuthenticationInfo(userInfo,userInfo.password(),userInfo.salt() == null || userInfo.salt().isEmpty()?ByteSource.Util.bytes(authConfigProperties.getConfiguration().getSecret()):ByteSource.Util.bytes(userInfo.salt()),getName());
        }
        return null;
    }
