...
//        generator("imm_state","state");
        generator("filesync","filesync");
    }

    private void generator(String databaseName,String name){
        FastAutoGenerator.create("jdbc:mysql://192.168.81.178:3306/"+databaseName+"?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai", "root", "blessme")  //数据库连接配置，必不可少的一个配置
...
//                            .enableSwagger() // 开启 swagger 模式
                ...
                .packageConfig(builder -> {   //包配置
                    builder.parent("cn.com.yl.fs.server") // 设置父包名
                ...
                .strategyConfig(builder -> {
                    builder.addTablePrefix("t_", "sys")
                            .addInclude("t_station_statistical")
                            .entityBuilder()
