...
public class UdpSocket {
    ...
    private void start() {
        try {
            ...
            bootstrap.group(group)
                    ...
                    .handler(new ChannelInitializer<NioDatagramChannel>() {
                        ...
                        protected void initChannel(NioDatagramChannel socketChannel) throws Exception {
                            ...
                            socketChannel.pipeline().addLast(new UdpSocketHandler());
                        }
                    });
            ...
            throw new RuntimeException(udpSocketConfig.getName() + "服务启动时发生异常",e);
        }
    }
    ...
    public ChannelFuture sendMessage(byte [] message,InetSocketAddress recipient){
        if(this.channel == null){
            throw new RuntimeException(udpSocketConfig.getName()+"服务没有启动！");
        }
